...
class MyBST(BST):
    ...
    def isSameShape(self, r1, r2):
        ...
        if r1 == None and r2 == None:
            ...
            return False 
        elif r1.left == None and r2.left == None and r1.right == None and r1.right == None:
            return True  
        else:
            return self.isSameShape(r1.right, r2.right)
            return self.isSameShape(r1.left, r2.left)          
